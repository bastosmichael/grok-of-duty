...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Grok Of Duty — Browser-Based Tactical FPS" },
      { name: "description", content: "Grok Of Duty is a browser-based 3D tactical shooter. Drop in, gear up, and dominate — no downloads required." },
      { name: "author", content: "Grok Of Duty" },
      { property: "og:title", content: "Grok Of Duty — Browser-Based Tactical FPS" },
      { property: "og:description", content: "A browser-based 3D tactical shooter. Drop in, gear up, dominate." },
